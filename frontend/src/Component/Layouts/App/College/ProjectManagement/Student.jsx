...
const Student = ({ selectedBatch = null, onBackToBatches = null, selectedCourse = null, onBackToCourses = null, selectedCenter = null, onBackToCenters = null }) => {
  ...
  const [profile, setProfile] = useState([
    {
      ...
      dailyAttendance: [
        ...
        { date: '2024-06-16', status: 'late', timeIn: '09:25', timeOut: '17:00', notes: 'Bus delay', lateMinutes: 25 },
        { date: '2024-06-15', status: 'present', timeIn: '08:58', timeOut: '17:00', notes: '', lateMinutes: 0 },
        { date: '2024-06-14', status: 'present', timeIn: '09:02', timeOut: '17:00', notes: '', lateMinutes: 2 },
        { date: '2024-06-13', status: 'halfDay', timeIn: '09:00', timeOut: '13:00', notes: 'Medical appointment', lateMinutes: 0 },
        { date: '2024-06-12', status: 'present', timeIn: '08:55', timeOut: '17:00', notes: '', lateMinutes: 0 },
        { date: '2024-06-11', status: 'late', timeIn: '09:30', timeOut: '17:00', notes: 'Personal work', lateMinutes: 30 }
      ]
    },
    {
      id: 2,
      ...
      dailyAttendance: [
        ...
        { date: '2024-06-18', status: 'late', timeIn: '09:20', timeOut: '17:00', notes: 'Bus delay', lateMinutes: 20 },
        { date: '2024-06-17', status: 'present', timeIn: '09:05', timeOut: '17:00', notes: '', lateMinutes: 5 },
        { date: '2024-06-16', status: 'present', timeIn: '08:58', timeOut: '17:00', notes: '', lateMinutes: 0 },
        { date: '2024-06-15', status: 'late', timeIn: '09:18', timeOut: '17:00', notes: 'Traffic', lateMinutes: 18 },
        { date: '2024-06-14', status: 'present', timeIn: '09:00', timeOut: '17:00', notes: '', lateMinutes: 0 },
        { date: '2024-06-13', status: 'absent', reason: 'Personal work', notes: 'Family emergency' },
        { date: '2024-06-12', status: 'present', timeIn: '09:10', timeOut: '17:00', notes: '', lateMinutes: 10 },
        { date: '2024-06-11', status: 'present', timeIn: '08:55', timeOut: '17:00', notes: '', lateMinutes: 0 }
      ]
    },
    // Adding Zero Period Students
    {
      ...
      dailyAttendance: [
        ...
        { date: '2024-06-18', status: 'present', timeIn: '08:58', timeOut: '13:00', notes: '', lateMinutes: 0 },
        { date: '2024-06-17', status: 'absent', reason: 'Personal work', notes: 'Family function' },
        { date: '2024-06-16', status: 'present', timeIn: '09:05', timeOut: '13:00', notes: '', lateMinutes: 5 },
        { date: '2024-06-15', status: 'late', timeIn: '09:20', timeOut: '13:00', notes: 'Bus delay', lateMinutes: 20 },
        { date: '2024-06-14', status: 'present', timeIn: '09:00', timeOut: '13:00', notes: '', lateMinutes: 0 },
        { date: '2024-06-13', status: 'present', timeIn: '08:55', timeOut: '13:00', notes: '', lateMinutes: 0 },
        { date: '2024-06-12', status: 'halfDay', timeIn: '09:00', timeOut: '11:30', notes: 'Medical appointment', lateMinutes: 0 },
        { date: '2024-06-11', status: 'present', timeIn: '09:10', timeOut: '13:00', notes: '', lateMinutes: 10 }
      ]
    }
  ]);
  ...
  const getTabCounts = () => {
    const counts = {
      all: profile.length,
      admission: profile.filter(s => s.admissionStatus === 'admitted' && s.status === 'active').length,
      zeroPeriod: profile.filter(s => s.admissionStatus === 'zeroPeriod').length,
      batchFreeze: profile.filter(s => s.admissionStatus === 'batchFreeze').length,
  ...
  const getAdmissionStatusBadge = (student) => {
    switch (student.admissionStatus) {
      ...
      case 'zeroPeriod':
        return <span className="badge bg-warning">Zero Period ({student.zeroPeriodDays || student.attendanceStats.totalWorkingDays} days)</span>;
      case 'batchFreeze':
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-md-8">
                    <div className="d-flex justify-content-end align-items-center gap-2">
                      ...
                      {showAttendanceControls && attendanceEligibleStudents.length > 0 && (
                        <>
                          {/* Time Filter */}
                      ...
                      <div className="d-flex align-items-center gap-3 flex-wrap">
                        <div className="d-flex align-items-center">
                          <input
                            ...
                            checked={selectedStudents.size === attendanceEligibleStudents.length && attendanceEligibleStudents.length > 0}
                            onChange={selectAllStudents}
                          />
                          <label className="form-check-label fw-bold">
                            Select All Eligible ({selectedStudents.size}/{attendanceEligibleStudents.length})
                          </label>
                        </div>
                          ...
                          <div className={`card-content transition-col mb-2`} key={studentIndex}>
                            ...
                            <div className="card border-0 shadow-sm mb-0 mt-2">
                              <div className="card-body px-3 py-3">
                                <div className="row align-items-center">
                                  {/* Student Info */}
                                  <div className={showAttendanceMode && isEligibleForAttendance ? "col-md-3" : "col-md-6"}>
                                    <div className="d-flex align-items-center">
                                      {/* Bulk Selection Checkbox */}
                                      {showAttendanceMode && showBulkControls && isEligibleForAttendance && (
                                  ...
                                  {/* ===== ENHANCED ATTENDANCE CONTROLS ===== */}
                                  {showAttendanceMode && isEligibleForAttendance && (
                                ...
                                {showAttendanceMode && isEligibleForAttendance && todayAttendance[student.id]?.isMarked && (

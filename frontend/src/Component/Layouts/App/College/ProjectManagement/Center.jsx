...
const Center = ({ selectedProject = null, onBackToProjects = null }) => {
  ...
  const handleSubmit = () => {
    if (!formData.code.trim() || !formData.name.trim() || !formData.city.trim() || !formData.capacity.trim()) {
            ...
            <ol className="breadcrumb">
              {onBackToProjects && (
                <li className="breadcrumb-item">
                  ...
                  >
                    {selectedProject ? `${selectedProject.name} Projects` : 'Projects'}
                  </button>
                </li>
              )}
              <li className="breadcrumb-item">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div>
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              <h4 className="mb-0">Centers</h4>
              {selectedProject && (
                <small className="text-muted">
                  Showing centers for: <strong>{selectedProject.name} ({selectedProject.code})</strong>
                </small>
              )}
            </div>
          </div>
        ...
        <div>
          ...
          <button className="btn btn-success" onClick={handleAdd}>Add Center</button>
        </div>
      </div>
                  ...
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    ...
                    >
                      <div className="d-flex align-items-center mb-2">
                        ...
                        <div>
                          <h5 className="card-title mb-1">{center.code}</h5>
                ...
                {selectedProject && (
                  <div className="mb-3">
                    ...
                    <input
                      type="text"
                      className="form-control"
                      value={`${selectedProject.code} - ${selectedProject.name}`}
                      readOnly
                      disabled
                    />
                    <small className="text-muted">Center will be linked to the current project</small>
                  </div>
                )}
                <div className="mb-3">

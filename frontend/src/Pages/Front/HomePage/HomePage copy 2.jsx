...
/* ─────────────────────────────────────────────────────────────────
   FOCALYT AURORA (Light Theme) — SCOPED STYLES (wrapped in .foc-cyber-home)
   Logo-inspired accents: Purple → Pink
...
/* Future Ready carousel — static card skins (no hover-driven layout) */
...
/* ── Our Approach fragment (merge into HomePage.jsx; OA_B & OA_TABS defined above) ── */
/* ══════════════════════════════════════════
...
/* ══════════════════════════════════════════
   PANEL 5 — ASSESSMENTS & CERTIFICATIONS
══════════════════════════════════════════ */
...
/* ══════════════════════════════════════════
   PANEL 7 — ENTREPRENEURSHIP & LIVELIHOODS
══════════════════════════════════════════ */
...
/* ── TABS ROW — desktop: centered wrap ── */
.oa-tabs-row {
...
/* ── tab label span — hidden on small screens ── */
        ...
        <div className="oa-header">
          ...
          <div className="oa-title-row">
            ...
            <div className="oa-sub-title">
              Mobilisation · Training Centers · Trainers · Training Delivery ·
              Assessments · Placements · Entrepreneurship
            </div>
          </div>

          {/* Pill tabs — wrapping on desktop, scrollable on mobile */}
        ...
        <section className="section grid-bg" id="events">
          <div className="container">
            <div className="section-head">
              ...
              <h2 className="sh2">
                <span className="cyan">Events</span>
              </h2>
        ...
        <section className="section grid-bg" id="future-courses">
          <div className="container">
            <div className="section-head">
              ...
              <h2 className="sh2">
                Future Ready <span className="cyan">Courses</span>
              </h2>
        ...
        <section className="section grid-bg" id="future-jobs">
          <div className="container">
            <div className="section-head">
              <div className="stag">Future Ready</div>
              <h2 className="sh2">
                Future Ready <span className="cyan">Jobs</span>
              </h2>

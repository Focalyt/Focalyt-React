...
const RequiredDocuments = () => {
  ...
  const [mergedDocs, setMergedDocs] = useState([
    ...
    },
    {
      ...
      uploads: [
        {
          uploadedAt: "2025-04-05T10:15:30",
    ...
    },
    {
      ...
      uploads: [
        {
          uploadedAt: "2025-04-03T09:25:20",
          fileUrl: "/sample-doc.pdf",
          status: "Rejected",
          reason: "Document not clear, please upload a better quality image"
        }
      ]
    }
  ]);
  ...
  const uploadFile = (docName, docId) => {
    alert(`Document "${docName}" would be uploaded in a real implementation`);
    removeFile(docId);
  };
  ...
  const renderFilePreview = (docId) => {
    ...
    return (
      <div className="preview-item">
        ...
        <div className="file-name">{file.name.length > 15 ? file.name.substring(0, 12) + '...' : file.name}</div>
      </div>
    );
  };
                  ...
                  <div id={`collapseOne${doc._id}`} style={{ display: 'none' }}>
                    <div className="pl-xl-0 pr-xl-1 pl-lg-0 pr-lg-1 pl-md-0 pr-md-1 px-sm-0 px-0 mx-auto">
                      <div className="table-content shadow-cashback shadow-cashback">
                        <div className="tab_head font-weight-bolder py-1 px-3">
                          Uploaded Document
                        </div>
                    ...
                    <div className="popupModel">
                      ...
                      <div className="contents">
                        ...
                        <div className="actions">
                          <label htmlFor={`${doc._id}PopUp`} className="button upload-btn">
                            Choose File
                            <input
                              type="file"
                              id={`${doc._id}PopUp`}
...
//   useEffect(() => {
//     // Get courseId from URL or context
...
//     try {
//       const response = await axios.get(`/candidate/reqDocs/${id}`, {
...
//     try {
//       await axios.post(`/candidate/reqDocs/${courseId}`, formData, {
//         headers: {

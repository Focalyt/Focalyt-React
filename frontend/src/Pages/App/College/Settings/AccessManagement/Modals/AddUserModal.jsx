                          ...
                          <div key={verticalId} className="col-md-6">
                            <div className="form-check">
                              <input
                                ...
                                id={`b2c_vert_${verticalId}`}
                              />
                              <label className="form-check-label" htmlFor={`b2c_vert_${verticalId}`}>
                                🏢 {vertical.name}
                              </label>
                            </div>
                            {isSelected && (
                                    ...
                                    return (
                                      <div key={projectId} className="form-check">
                                        <input
                                          ...
                                          id={`b2c_proj_${projectId}`}
                                        />
                                        <label className="form-check-label" htmlFor={`b2c_proj_${projectId}`}>
                                          📋 {project.name}
                                        </label>
                                      </div>
                                    );

...
const getAvailableCourses = (selectedCenters, selectedProjects) => {
  ...
  return enhancedEntities.COURSE.filter(course => {
    ...
    const centerMatch = selectedCenters && selectedCenters.length > 0
      ? course.centers.some(centerId => selectedCenters.includes(centerId))
    ...
    const projectMatch = selectedProjects && selectedProjects.length > 0
      ? (Array.isArray(course.project) 
          ? course.project.some(projId => selectedProjects.includes(projId)) 
  ...
  const updateHierarchicalSelection = (level, selectedIds) => {
    const newSelection = { ...userForm.permissions.view_permissions.hierarchical_selection };
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="border rounded p-3" style={{ maxHeight: '200px', overflowY: 'auto' }}>
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div className="small">
                          <button
                            ...
                            onClick={() => setUserForm({
                              ...userForm,
                              reporting_managers: dummyReportingManagers.map(m => m.id)
                            })}
                          >
                            Select All
                          </button>
                      ...
                      {dummyReportingManagers.map(manager => (
                        <div key={manager.id} className="form-check mb-3 p-2 border-bottom">
                          <input
                            type="checkbox"
                            className="form-check-input"
                            checked={userForm.reporting_managers.includes(manager.id)}
                            onChange={(e) => {
                              const updated = e.target.checked
                                ? [...userForm.reporting_managers, manager.id]
                                : userForm.reporting_managers.filter(id => id !== manager.id);
                        ...
                        <div className="card-body">
                          ...
                          {userForm.permissions.view_permissions.hierarchical_selection.selected_courses.length > 0 && (
                            <div className="mb-4">
                              ...
                              <div className="border rounded p-3 bg-white shadow-sm">
                                {(() => {
                                  const availableBatches = getAvailableBatches(userForm.permissions.view_permissions.hierarchical_selection.selected_courses);
                ...
                <>
                  {(userForm.permissions.permission_type === 'lead_based') && (
                    <div className="col-12">
                      ...
                      <h5 className="border-bottom pb-2">Permissions</h5>
                      <div className="mt-3">
                        {/* Global or Specific Choice */}
                        <div className="row g-2 mb-4">
                          <div className="col-12">

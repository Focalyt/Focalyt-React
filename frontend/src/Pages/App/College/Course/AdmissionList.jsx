...
const AdmissionList = () => {
  ...
  const [admissionFilters, setAdmissionFilters] = useState([
    ...
    { _id: 'batchFreeze', name: 'Batch Freezed', count: 4, milestone: '' },
...
const downloadApplicationForm = async (candidateId) => {
  try {
    const response = await axios.get(
      `${backendUrl}/college/generate-application-form/${candidateId}`,
      {
    ...
    link.href = url;
    link.setAttribute('download', 'application_form.pdf'); // File name
    ...
    <div className="container-fluid">
      <div className="row">
        <div className={isMobile ? 'col-12' : mainContentClass}>
              ...
              <div className="container-fluid py-4">
                ...
                <div className="row g-4">
                  ...
                  <MultiSelectCheckbox
                      title="Verticals"
                      options={sectorOptions}
                      selectedValues={formData.vertical.values}
          ...
          {/* Main Content */}
          <div className="content-body" style={{ marginTop: '170px' }}>
                                        ...
                                        <div style={{ position: "relative", display: "inline-block" }}>
                                          ...
                                          >
                                            <button
                                              ...
                                              onClick={() => downloadApplicationForm(profile)}
                                            >
                                        ...
                                        <div style={{ position: "relative", display: "inline-block" }}>
                                          ...
                                          >
                                            <button
                                              ...
                                              onClick={() => downloadApplicationForm(profile._id)}
                                            >
                                              Download Application Form
                                            </button>
                                            <button

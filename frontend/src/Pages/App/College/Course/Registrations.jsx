      ...
      <div className="card border-0 shadow-sm">
        <div className="card-header bg-white d-flex justify-content-between align-items-center py-3 border-bottom">
          <div className="d-flex align-items-center">
            ...
            <h6 className="mb-0 followUp fw-medium">Edit Followup</h6>
          </div>
          <div>
...
.stickyBreakpoints {
  ...
  z-index: 10;
        ...
        // pagination css
        /* Beautiful Pagination CSS - Add this to your existing CSS */
...
/* First and last button special styling */
...
/* Alternative color schemes - Add these classes to .pagination for different looks */

/* Orange theme */
.pagination.orange-theme .page-link {
    border-color: #ffe0b3;
    color: #ff6b35;
}

.pagination.orange-theme .page-link:hover,
.pagination.orange-theme .page-item.active .page-link {
    background: linear-gradient(135deg, #ff6b35, #ff5722);
    border-color: #ff6b35;
}

/* Green theme */
.pagination.green-theme .page-link {
    border-color: #c8e6c9;
    color: #4caf50;
}

.pagination.green-theme .page-link:hover,
...
/* Purple theme */
.pagination.purple-theme .page-link {
    border-color: #e1bee7;
    color: #9c27b0;
}

.pagination.purple-theme .page-link:hover,
.pagination.purple-theme .page-item.active .page-link {
    background: linear-gradient(135deg, #9c27b0, #7b1fa2);
    border-color: #9c27b0;
}

/* Dark theme */
.pagination.dark-theme .page-link {
    background: linear-gradient(145deg, #424242, #303030);
    border-color: #555555;
    color: #ffffff;
}

.pagination.dark-theme .page-link:hover,
.pagination.dark-theme .page-item.active .page-link {
    background: linear-gradient(135deg, #666666, #424242);
    border-color: #666666;
}

/* Minimal flat design */
.pagination.flat-design .page-link {
    background: #ffffff;
...
.pagination.flat-design .page-link:hover {
    background: #007bff;
    border-color: #007bff;
    box-shadow: none;
    transform: none;
...
.pagination.flat-design .page-item.active .page-link {
    background: #007bff;
    border-color: #007bff;
    box-shadow: none;
    transform: none;

...
const AddCourse = () => {
  ...
  // Course structure levels (UI only — not sent to backend)
  ...
  const toggleStructureLevel = (level) => {
    setStructureLevels((prev) => ({ ...prev, [level]: !prev[level] }));
  };
                ...
                <div className="card-content">
                  <div className="card-body">
                    <p className="course-structure-hint">
                      Define which levels this course uses for session planning (Academic Coordinator).
                      This is UI-only and is not sent to the backend.
                    </p>
                    ...
                    <div className="course-structure-levels">
                      ...
                      <button
                        type="button"
                        className={`course-structure-level${structureLevels.session ? ' is-active' : ''}`}
                        onClick={() => toggleStructureLevel('session')}
                        aria-pressed={structureLevels.session}
                      >

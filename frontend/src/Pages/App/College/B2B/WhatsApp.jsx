...
const renderWhatsAppPanel = () => {
                ...
                <div className="row align-items-center gy-2">
                  <div className="col-md-5 col-xl-4 d-none d-md-block">
                    <div className="d-flex align-items-center flex-wrap">
                      <h5 className="fw-bold text-dark mb-0 me-3" style={{ fontSize: '1.1rem' }}>WhatsApp</h5>
                      ...
                      <div className={`lead-card ${((bulkMode === 'bulkrefer' || bulkMode === 'bulkaction' || bulkMode === 'whatsapp') && (selectedProfiles || []).includes(lead._id)) ? 'bulk-selected' : ''}`}>
                        ...
                        <div className="lead-header lead-header-v2">
                          <div className="lead-header-v2__row">
                              ...
                              <div className="lead-header-v2__actions">
                                <button
                                  type="button"
                                  className="lead-header-v2__action-btn lead-header-v2__action-btn--wa"
                                  onClick={(e) => {
                                    e.preventDefault();
                                    e.stopPropagation();
                                ...
                                <button
                                  type="button"
                                  className="lead-header-v2__action-btn lead-header-v2__action-btn--open"
  ...
  .lead-header-v2__action-btn--wa{
    border: 1px solid rgba(37, 211, 102, 0.95);
    background: rgba(37, 211, 102, 0.95);
    color: #fff;
  }

  .lead-header-v2__action-btn--wa:hover{
    background: rgba(37, 211, 102, 1);
  }

  .lead-header-v2__action-btn--wa i{
    font-size: 16px;
  }

  .lead-header-v2__action-btn--open{
    border: 1px solid rgba(255,255,255,0.85);
    background: rgba(255,255,255,0.92);
    color: #0b5ed7;
  }

  .lead-header-v2__action-btn--open:hover{
    background: #fff;
  }

  @media (max-width: 768px){
    .lead-header.lead-header-v2{
      padding-right: 12px;
    }
...
position: absolute;
  ...
  @media (max-width: 768px){
    .lead-header-v2__left{ min-width: 0; max-width: none; }
    .lead-header-v2__row{ flex-wrap: nowrap; align-items: center; }
    .lead-header-v2__left{ flex: 1 1 auto; }
    .lead-header-v2__input-row{ flex-wrap: nowrap; flex-direction: column; }
    .lead-header-v2__input-wrap{ min-width: 0; flex: 1 1 auto; width: 100%; }
    .lead-header-v2__right{
      flex: 1 1 100%;
      justify-content: flex-start;
      flex-wrap: wrap;

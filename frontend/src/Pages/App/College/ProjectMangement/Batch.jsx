    ...
    <div className="container py-4 vt-page vt-screen-enter">
      <div className="row">
        <div className={mainContentClass}>
          <div className="vt-shell" style={{ marginBottom: 16 }}>
          <div className="vt-head">
            <div>
              ...
              <div className="vt-crumb">
                ...
                {onBackToCourses && selectedCourse && (
                  <>
                    <span>/</span>
                    <button type="button" onClick={onBackToCourses}>{selectedCourse.name || 'Course'}</button>
                  </>
                )}
                <span>/</span>
            ...
            <div className="vt-head-actions">
              {onBackToCourses && (
                <button type="button" className="vt-back" onClick={onBackToCourses}>
          ...
          <div className="vt-toolbar" ref={navRef}>
              ...
              {mainTab === 'Batches'
                ? ['Active Batches', 'Inactive Batches', 'All Batches'].map(tab => (
                  <button
                    type="button"
                    key={tab}
                    className={batchSubTab === tab ? 'is-active' : ''}
              ...
              <table className="vt-table">
                ...
                <tbody>
                  {filteredBatches.map(batch => {
                    ...
                    return (
                      <tr key={batch._id || batch.id} className="vt-row" title="Open students" onClick={() => handleBatchClick(batch)}>
                        <td>
                          <span className="vt-name">
                            <span className="vt-avatar">{(batch.name || batch.code || '?').charAt(0).toUpperCase()}</span>
                        ...
                        <td onClick={(e) => e.stopPropagation()}>
                          <div className="vt-actions">
                            ...
                            <button type="button" title="Edit" onClick={() => handleEdit(batch)}>
                              <i className="bi bi-pencil"></i>
                            </button>
                            <button type="button" className="is-danger" title="Delete" onClick={() => handleDelete(batch)}>

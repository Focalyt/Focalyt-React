...
const userSchema = new Schema(
	{
		...
		my_team: [ObjectId],
		// Selected B2B department IDs the user can access (Access Management)
		...
		permissions: {
			...
			custom_permissions: {
				...
				can_edit_b2b_project: { type: Boolean, default: false },
				can_edit_b2b_department: { type: Boolean, default: false },
